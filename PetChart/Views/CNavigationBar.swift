...
class CNavigationBar: UINavigationBar {
    ...
    class func drawBackButton(_ controller: UIViewController, _ title: String?, _ selctor:Selector) {
        ...
        button.setImage(UIImage(named: "path_4"), for: .normal)
        ...
        let img = UIImage.image(from: ColorDefault)!
        naviBar?.tintColor = UIColor.white
        naviBar?.barTintColor = ColorDefault
